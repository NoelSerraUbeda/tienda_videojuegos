class PrincipalNavbar extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        this.shadow.innerHTML =
            ...
            <nav class="navbar">
                <a href="inicio.html">
                    <div class="navbar_logo"><img src="icons/logo.svg" title="Return to index" alt="logo"></div>
                </a>
                ...
                <div class="navbar_user_options">
                    ...
                    <a href="https://media.tenor.com/wto_9CjqJTcAAAAM/dance-cat.gif">
...
customElements.define('navbar-component', PrincipalNavbar);
